...
namespace Hellmade.Sound
{
    public class SoundPocket : MonoBehaviour
    {
        ...
        public float CurrentMusicFadeOutSeconds = 2f;
        //
        ...
        /// <summary>
        /// Do not use it for anything other than background music
        /// </summary>
        /// because if there is no active sound check on another scene, 
        /// the sounds simply overlap each other.
        ...
        // Plays all the assigned clips at the same time. DOESN'T WORK FOR MUSIC
